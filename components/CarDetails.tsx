        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="relative w-full max-w-lg max-h[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadowm-xl transition-all flex flex-col">
                  <button
                    type="button"
                  ...
                  <div className="flex-1 fkex flex-col gap-2">
                    ...
                    <div className="flex flex-wrap gap-4 mt-3">
                      {Object.entries(car).map(([key, value]) => (
                        <div className="flex justify-between gpa-5 w-full text-right" key={key}>
